                ...
                <form method="post" action="{{ route('dashboard.settings.store') }}">
                  ...
                  {{-- client id --}}
                    <div class="form-group">
                        <label>{{ $social_site }} cliend id</label>
                        <input type="text" name="{{ $social_site }}_cliend_id" class="form-control" value="{{ setting($social_site . '_client_id') }}">
                    </div>

                    {{-- secret --}}
                    <div class="form-group">
                        <label>{{ $social_site }} cliend id</label>
                        <input type="text" name="{{ $social_site }}_cliend_secret" class="form-control" value="{{ setting($social_site . '_client_secret') }}">
                    </div>
